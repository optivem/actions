...
- Per-scope counts for each scope written (external: N naming / M parameter / K devops / …; internal: …). Omit the scope that was not produced.
- Top 3 items by impact per scope written. Omit the scope that was not produced.
